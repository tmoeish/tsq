...
func renderDDLCreateTable(table *genmodel.StructInfo, columns []string, dialect ddlDialectSpec) string {
	var buf strings.Builder
...
func renderDDLIndexStatements(table *genmodel.StructInfo, dialect ddlDialectSpec) ([]string, error) {
...
func orderedDDLFields(table *genmodel.StructInfo) []genmodel.FieldInfo {
	fields := make([]genmodel.FieldInfo, 0, len(table.Fields))
