...
func OnExtra[Left, Right Table](on JoinOn[Left, Right]) JoinCond[Left, Right] {
	return JoinCond[Left, Right](on)
}

// OnLeft converts a left-table predicate into a typed ON condition.
func OnLeft[Left, Right Table](pred Pred[Left]) JoinCond[Left, Right] {
	return JoinCond[Left, Right](pred)
}

// OnRight converts a right-table predicate into a typed ON condition.
func OnRight[Left, Right Table](pred Pred[Right]) JoinCond[Left, Right] {
	return JoinCond[Left, Right](pred)
}
