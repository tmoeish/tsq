...
var (
	Order_Amount    = tsq.NewCol[Order, int64]("amount", "Amount", func(t *Order) *int64 { return &t.Amount })
	Order_CreatedAt = tsq.NewCol[Order, tsqtime.Time]("created_at", "created_at", func(t *Order) *tsqtime.Time { return &t.CreatedAt })
	Order_DeletedAt = tsq.NewCol[Order, int64]("deleted_at", "deleted_at", func(t *Order) *int64 { return &t.DeletedAt })
	Order_ItemID    = tsq.NewCol[Order, int64]("item_id", "ItemID", func(t *Order) *int64 { return &t.ItemID })
	Order_Price     = tsq.NewCol[Order, int64]("price", "Price", func(t *Order) *int64 { return &t.Price })
	Order_Status    = tsq.NewCol[Order, OrderStatus]("status", "Status", func(t *Order) *OrderStatus { return &t.Status })
	Order_UID       = tsq.NewCol[Order, int64]("uid", "uid", func(t *Order) *int64 { return &t.UID })
	Order_UpdatedAt = tsq.NewCol[Order, null.Time]("updated_at", "updated_at", func(t *Order) *null.Time { return &t.UpdatedAt })
	Order_UserID    = tsq.NewCol[Order, int64]("user_id", "UserID", func(t *Order) *int64 { return &t.UserID })
	Order_Version   = tsq.NewCol[Order, int64]("version", "version", func(t *Order) *int64 { return &t.Version })
)

// TableOrderCols is the list of columns for Order table.
var TableOrderCols = []tsq.SelectableColumn[Order]{
	Order_Amount,
	Order_CreatedAt,
	Order_DeletedAt,
	Order_ItemID,
...
func (o Order) Cols() []tsq.SelectableColumn[Order] {
