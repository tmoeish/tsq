// Code generated by tsq-v4.1.8. DO NOT EDIT.
...
// =============================================================================
// Table Registration and Declared Index Metadata
// =============================================================================
...
func init() {
	tsq.RegisterTable(
		...
		tsq.TableIndex{Name: "idx_enrollment_course_id", Fields: []string{"deleted_at", "course_id"}},
		tsq.TableIndex{Name: "idx_enrollment_learner_id_course_id", Fields: []string{"deleted_at", "learner_id", "course_id"}},
		tsq.TableIndex{Name: "idx_enrollment_status", Fields: []string{"deleted_at", "status"}},
	)
}
